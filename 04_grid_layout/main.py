...
button_submit = Button(mainwindow, text="Enter", bg="#fcfcf0", activebackground="#fcffcf")
button_submit.config(relief=RIDGE, bd=1)
button_submit.grid(row=6, column=0)
button_quit = Button(mainwindow, text="Quit", bg="#fcfcf0", activebackground="#fcffcf", command = quitapp)
